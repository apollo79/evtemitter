...
export type Fn<Params extends readonly unknown[] = readonly unknown[], Result = unknown> =
...
export class EventEmitter<T extends CustomEventMap = Record<never, never>> extends EventTarget {
    /**
    ...
    protected getOrCreateListeners<K extends keyof T & string>(type: K): Set<CustomEventCallback<string, unknown>> {
     ...
     * @param type the typed event name
     * @param callback the typed callback function to remove
    ...
    /**
     * remove a callback for a multiple given events
     * @param type the array with the typed event names
     * @param callback the typed callback function to remove
     * @param options the options
     */
    removeEventListener<K extends keyof T & string>(
    ...
    /**
     * remove all callback for multiple given events
     */
    removeEventListener<K extends keyof T & string>(): this;

    /**
     * remove all callbacks for all events
     * @param types the array with the event name
     * @param callback the typed callback function to remove
     * @param options the options
     */
    removeEventListener<K extends keyof T & string>(
    ...
    /**
     * remove a callback for an or multiple events
    ...
    emit<K extends keyof T & string>(
        ...
        const event = EventEmitter.createEvent(type, detail) as unknown as Values<T>;
